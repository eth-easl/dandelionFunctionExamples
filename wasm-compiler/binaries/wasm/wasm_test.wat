(module
  ...
  (func $_start (type 0)
    (local i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i64 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i64 i64 i64 i64 i64 i64 i32 i32 i32 i32 i32 i32 i32 i32 i64 i64 i64 i32 i32 i32 i32 i64 i64 i64 i64 i64 i64 i64 i32 i32 i32 i64 i32 i32 i32 i32 i32 i32 i32 i64 i64 i64 i64 i32 i32 i32 i32 i32 i32 i64 i64 i64 i64 i32 i32 i32 i32 i32 i32 i64 i64 i64 i64 i32 i32 i32 i32 i32 i32 i64 i64 i64 i32 i32 i64 i64 i32 i32 i32 i32 i64 i32 i32 i32 i64 i64 i64 i32 i32 i64 i64 i32 i32 i32 i32 i64 i64 i32 i32 i32 i64 i64 i64 i32 i32 i64 i64 i32 i32 i32 i32 i64 i64 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i64 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i64 i64 i64 i64 i64 i64 i64 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i64 i64 i32 i32 i32 i32 i32 i32)
  ...
  (func $dandelion_init (type 0)
    ...
    global.set $__stack_pointer
    return)
  (func $dandelion_alloc (type 1) (param i32 i32) (result i32)
    ...
    local.get 41
    return)
  (func $dandelion_exit (type 2) (param i32)
    ...
    global.set $__stack_pointer
    return)
  (func $dandelion_set_thread_pointer (type 2) (param i32)
    ...
    global.set $__stack_pointer
    return)
  (func $dandelion_input_set_count (type 3) (result i32)
    (local i32 i32)
    i32.const 0
    local.set 0
    local.get 0
    ...
    local.get 1
    return)
  (func $dandelion_output_set_count (type 3) (result i32)
    (local i32 i32)
    i32.const 0
    local.set 0
    local.get 0
  ...
  (func $dandelion_input_buffer_count (type 4) (param i32) (result i32)
    ...
    local.get 20
    return)
  (func $dandelion_get_input (type 1) (param i32 i32) (result i32)
  ...
  (func $__dandelion_system_exit (type 0)
    ...
    return)
  (func $__dandelion_system_set_thread_pointer (type 2) (param i32)
    (local i32 i32 i32 i32 i32 i32)
    global.get $__stack_pointer
    local.set 1
    i32.const 16
  ...
  (func $__dandelion_platform_exit (type 0)
    return)
  (func $__dandelion_platform_set_thread_pointer (type 2) (param i32)
    (local i32 i32 i32)
    global.get $__stack_pointer
    local.set 1
    i32.const 16
